            ...
            return {
                ...
                link: function() {
                    var listener = function(event, toState) {
                        var default_title = 'Magazin Admin';
                        $timeout(function() {
    ...
    .directive('sidebarPrimaryToggle', [
        ...
        function ($rootScope, $window, $timeout) {
            return {
                ...
                replace: true,
                scope: true,
                template: '<a id="sSwitch_primary" href="#" class="sSwitch sSwitch_left" ng-click="togglePrimarySidebar($event)" ng-hide="miniSidebarActive"><span class="sSwitchIcon"></span></a>',
        ...
        function ($rootScope) {
            return {
                ...
                link: function (scope, el, attrs) {
                    ...
                    $(el).wrapInner("<div class='scrollbar-inner'></div>");
                    if(Modernizr.touch) {
