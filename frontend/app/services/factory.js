angular
    ...
    .factory('utils', function () {
        return {
            ...
            findByInvoiceId: function findById(a, id) {
                for (var i = 0; i < a.length; i++) {
                    if (a[i].invoice_id == id) return a[i];
                }
                return null;
            },
            // serialize form
    ...
    .factory('UserAuth',['$window',function($window) {
        var userAuth = {
            isLogged: $window.sessionStorage.isLogged,
            role: $window.sessionStorage.role,
            apiKey:$window.sessionStorage.token,
