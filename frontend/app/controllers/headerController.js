angular
    ...
    .controller('main_headerController', [
        ...
        function ($timeout,$scope,$window,variables,User) {
            ...
            $scope.user_data = {
                name: "Lue Feest",
                avatar: variables.imgPath+"assets/img/avatars/avatar_11_tn.png",
                alerts: [
                    {
                ...
                messages: [
                    ...
                    },
                    {
                        ...
                        "sender": "Alia Walter",
                        "color": "indigo",
                        "avatar": variables.imgPath+"assets/img/avatars/avatar_07_tn.png"
                    },
                    {
                        "title": "At quia quis.",
                    ...
                    },
                    {
                        ...
                        "color": "amber",
                        "avatar": variables.imgPath+"assets/img/avatars/avatar_09_tn.png"
                    }
                ]
            };
