angular
    ...
    .controller('dashboardController', [
        ...
        '$timeout',
        'variables',
        function ($rootScope,$scope,$interval,$timeout,variables) {

            $scope.path = variables.imgPath;
        // statistics
            $scope.dynamicStats = [
                {
                    id: '1',
        ...
        // weather
            $scope.weatherToday = {
                city: 'Some City',
                backgroundImg: variables.imgPath+'assets/img/gallery/Image17.jpg',
    ...
    // google maps
    .controller('userMapsController', [
        '$rootScope',
        '$scope',
        '$timeout',
        'utils',
        'variables',
        function($rootScope,$scope, $timeout,utils,variables) {
            ...
            $scope.gmap_users = [
                {
                    ...
                    avatar: variables.imgPath+"assets/img/avatars/avatar_01_tn.png",
                    lat: "37.406267",
                    lon: "-122.06742"
                },
                {
                    name: "Lelah Leffler",
                    company: "Rowe PLC",
                    avatar: variables.imgPath+"assets/img/avatars/avatar_02_tn.png",
                    lat: "37.379267",
                    lon: "-122.02148"
                },
                {
                    name: "Lawson Kiehn",
                    company: "Legros Inc",
                    avatar: variables.imgPath+"assets/img/avatars/avatar_03_tn.png",
                    lat: "37.410267",
                    lon: "-122.11048"
                },
                {
                    ...
                    avatar: variables.imgPath+"assets/img/avatars/avatar_04_tn.png",
                    lat: "37.397267",
                    lon: "-122.084417"
                },{
                    name: "Neoma Littel",
                    company: "Conn-Ferry",
                    avatar: variables.imgPath+"assets/img/avatars/avatar_05_tn.png",
                    lat: "37.372267",
                    lon: "-122.090417"
                }
            ];
