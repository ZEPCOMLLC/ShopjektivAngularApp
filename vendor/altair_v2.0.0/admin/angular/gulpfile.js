...
// commmon
gulp.task('angular_common_js', function () {
    return gulp.src([
...
// cutom uikit
gulp.task('angular_uikit_js', function () {
    return gulp.src([
        // uikit core
...
// main styles
gulp.task('angular_less_main', function() {
...
gulp.task('angular_json_minify', function() {
    return gulp.src([
            'data/*.json',
            '!data/*.min.json'
        ])
...
gulp.task('angular_browser-sync', function() {

    browserSync.init({
        // http://www.browsersync.io/docs/options/#option-host
        host: "192.168.1.2",
        // http://www.browsersync.io/docs/options/#option-proxy
        proxy: "localhost/altair_angular/",
...
gulp.task('default', function(callback) {
    return plugins.runSequence(
        ['angular_common_js','custom_js_minify','angular_uikit_js','angular_less_main'],
        callback
    );
});