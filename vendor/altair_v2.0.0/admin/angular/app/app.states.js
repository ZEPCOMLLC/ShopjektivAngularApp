    ...
    .config([
        ...
        function ($stateProvider, $urlRouterProvider) {
            ...
            // -- DASHBOARD --
                ...
                .state("restricted.forms.wysiwyg", {
                    url: "/wysiwyg",
                    templateUrl: 'app/components/forms/wysiwyg_editorView.html',
                    controller: 'wysiwygCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_wysiwyg',
                                'app/components/forms/wysiwyg_editorController.js'
                            ], {serie:true});
                        }]
                    },
                    data: {
                        pageTitle: 'WYSIWYG Editor'
                    }
                })
            ...
            // -- PAGES --
                .state("restricted.pages", {
                    url: "/pages",
                    template: '<ui-view autoscroll="false" ng-class="{ \'uk-height-1-1\': page_full_height }" />',
                    abstract: true
                })
                ...
                .state("restricted.pages.invoices", {
                    url: "/invoices",
                    templateUrl: 'app/components/pages/invoicesView.html',
