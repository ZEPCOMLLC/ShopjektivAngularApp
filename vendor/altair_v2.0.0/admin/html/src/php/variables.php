...
require_once '/helpers/faker/autoload.php';
$faker = Faker\Factory::create();

// Parse, validate, manipulate, and display dates in PHP w/ i18n support. Inspired by moment.js
require_once '/helpers/moment/Moment.php';
require_once '/helpers/moment/MomentLocale.php';
require_once '/helpers/moment/MomentFromVo.php';
require_once '/helpers/moment/MomentPeriodVo.php';
...
if(substr($sPage, 0, 5 ) === "forms") {
    ...
    <!-- inputmask-->
    <script src="'.$bower_url.'/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js"></script>
...
if(substr($sPage, 0, 7 ) === "plugins") {
    ...
    <script src="'.$bower_url.'/tablesorter/addons/pager/jquery.tablesorter.pager.js"></script>
...
if(substr($sPage, 0, 4 ) === "page") {
    ...
    if($pages_sPage[1] == 'user_profile') {
    $scripts = '
    <!-- magnific popup -->
    <script src="'.$bower_url.'/magnific-popup/dist/jquery.magnific-popup'.$dist_min.'.js"></script>

    <!--  user profile functions -->
    <script src="assets/js/pages/page_user_profile'.$dist_min.'.js"></script>
    ';
    }
